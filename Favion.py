...
/* BARU: ANIMASI LOADING 3 TITIK */
.typing-indicator{{display:flex;align-items:center;gap:6px;padding:8px 0}}
.typing-indicator span{{width:8px;height:8px;background-color:{T['badge_text']};border-radius:50%;display:inline-block;animation:bounce 1.4s infinite ease-in-out both}}
...
def kirim_ke_ai(prompt, image=None):
    ...
    # BARU: Tampilkan animasi loading 3 titik
    ...
    loading_placeholder.empty()  # Hapus animasi loading
